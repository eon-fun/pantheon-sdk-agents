...
def _ensure_libp2p_path():
    ...
    if "/serve_app/py-libp2p" not in sys.path and "/Users/drobotukhin/Desktop/PantheonAI/agents/base-agent/py-libp2p" not in sys.path:
        if os.path.exists("/serve_app/py-libp2p"):
            sys.path.insert(0, "/serve_app/py-libp2p")
        else:
            sys.path.insert(0, "/Users/drobotukhin/Desktop/PantheonAI/agents/base-agent/py-libp2p")
    ...
    try:
        ...
        async def _setup_libp2p_in_trio():
            ...
            cfg = RelayConfig(
                ...
                enable_stop=True,
                enable_client=True,
                bootstrap_relays=[info_from_p2p_addr(Multiaddr("/dns4/relay-service.dev.pntheon.ai/tcp/9000/p2p/12D3KooWR2ykSpRSRoqdVmrqrm55sWuLz8jQPrnGoUPsiwTQ7Dd2"))],
            )
...
def diagnose_libp2p_environment() -> dict:
    ...
    possible_paths = [
        "/serve_app/py-libp2p",
        "/Users/drobotukhin/Desktop/PantheonAI/agents/base-agent/py-libp2p",
